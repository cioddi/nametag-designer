...
* @returns {Boolean}
*/
hasPointInside_c1 = (p0, p1, p2) => (p1.y > p0.y) !== (p2.y > p0.y)
hasPointInside_c2 = (p0, p1, p2) => (p0.x < (p2.x - p1.x) * (p0.y - p1.y) / (p2.y - p1.y) + p1.x)
...
const hasPointInside = function (cag, p0) {
  ...
  cag.sides.forEach(side => {
    p1 = side.vertex0.pos
    p2 = side.vertex1.pos
    if (hasPointInside_c1(p0, p1, p2) && hasPointInside_c2(p0, p1, p2)) {
      inside = !inside
    }
  })
  return inside

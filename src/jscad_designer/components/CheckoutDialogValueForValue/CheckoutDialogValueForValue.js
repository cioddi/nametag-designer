      ...
      <DialogContent dividers>
        ...
        {state.show === 'payment_method_selection' && (
          <div className="payment_method">
            ...
            */}
            <Grid container spacing={4} key={'payment_method_selection_3'}>
              <Grid item xs={12}>
                <Typography
                  variant="body1"
                  component="p"
              ...
              <Grid item xs={12}>
                ...
                <List>
                  <ListItem
                    key={'payment_method_selection_list_item_stripe'}
                    role={undefined}
                    dense
                    button
                    onClick={() => {
                      handlePaymentMethodSelection('stripe');
                    }}>
                    <ListItemIcon>
                      <Radio
                        edge="start"
                        checked={
                          state.payment_method === 'stripe' ? true : false
                        }
                        inputProps={{
                          'aria-labelledby': 'stripe_payment_method_label'
                        }}
                      />
                    </ListItemIcon>
                    <ListItemText
                      ...
                      <img
                        style={{ marginRight: '5px' }}
                        title="Credit card"
                        src="/images/payment_option_cc.svg"
                      />{' '}
                      powered by stripe
                    </ListItemText>
                  </ListItem>
                  <ListItem
                    key={'payment_method_selection_list_item_paypal'}
                    role={undefined}
                    dense
                    button
                    onClick={() => {
                    ...
                    <ListItemIcon>
                      <Radio
                        edge="start"
                        checked={
                          state.payment_method === 'paypal' ? true : false
                        }
                        inputProps={{
                          'aria-labelledby': 'paypal_payment_method_label'
                        }}
                      />
                    </ListItemIcon>
                    <ListItemText
                      ...
                      <img
                        style={{ marginRight: '5px' }}
                        title="PayPal"
                        src="/images/payment_option_paypal.svg"
                      />
                    </ListItemText>
                  </ListItem>
                </List>
        ...
        {state.show === 'success_message' && (
          <Grid container spacing={4} key={'payment_method_selection_2'}>
            {/**            <Grid
              item
              xs={12}
            >
...
<br/>Contact: service@nametag-designer.com
            ...
            <Grid item xs={12}>
              <Paper style={{ backgroundColor: '#f1ffde' }}>
                <Typography
                  ...
                  component="div">
                  <strong style={{ fontSize: '1.3em', color: '#2e7d32' }}>
                    Success!
                  </strong>
                  <br />
                  <br />
                  ...
                  <div
                    ...
                    <strong style={{ color: '#1976d2' }}>
                      Thank you for using Nametag Designer!
                    </strong>
                    <br />
                    <br />
                    If you found this tool helpful, please consider sharing it
                    with others:
                    <br />
                    <br />
                    <strong>Tell your friends and colleagues</strong> about this
                    free tool
                    <br />
                    <strong>Share on social media</strong> and help others
                    discover it
                    <br />
                    <strong>
                      Link to cioddi.github.io/nametag-designer/
                    </strong>{' '}
                    in your posts
                    <br />
                    <br />
                    <em style={{ color: '#666', fontSize: '0.9em' }}>
                      Your support helps keep this project alive and free for
                      everyone!
                    </em>
                  </div>
                </Typography>
      ...
      <DialogActions>
        <Grid container spacing={2} key={'payment_method_selection_2'}>
          <Grid item xs={6}>
            <Button

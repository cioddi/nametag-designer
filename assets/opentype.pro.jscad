...
console.log('blablub 3');
	    var hmtxTable = uncompressTable(data, hmtxTableEntry);
	    hmtx.parse(hmtxTable.data, hmtxTable.offset, font.numberOfHMetrics, font.numGlyphs, font.glyphs);
	    addGlyphNames(font);

console.log('blablub 4');
	    if (kernTableEntry) {
...
//        console.log("got close");
      ...
      case "L": // line
        ...
        break;
      case "C": // curve TODO
        np = np.appendBezier([[cmd.x1, -cmd.y1],[cmd.x2, -cmd.y2],[cmd.x, -cmd.y]], {resolution: 90}); // default = 32
        break;
      case "Q": // quadrathingy TODO
        np = np.appendBezier([[cmd.x1, -cmd.y1],[cmd.x, -cmd.y]], {resolution: 90});
        break;
    }
  }
  return csgPath;
...
const cagFromString = (font, str, size, options) => { // TODO add other params
